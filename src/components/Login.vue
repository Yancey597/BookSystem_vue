  ...
  <div class="login_container">
    ...
    <div class="rights">
      ...
      <div class="login_box">
        ...
        <h2 style="margin-top:-5em; font-size:40px;margin-left: 0.5em">用户登录</h2>
        <p style="color:#797979; margin-top:5px; font-size:19px;margin-left: 1em">log in to continue in our AI
          library </p>
        <!-- 登录表单区域 -->
        <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
          ...
          <el-form-item class="btns">
            <el-button type="primary" @click="login" :loading="loginLoading"
                       style="height:50px;line-height: 12px;margin-left: -5.5em">
              登录
            </el-button>
    ...
    <div class="footer">
      <span style="font-weight: bold;color:white;margin-bottom: 10px">
        ...
        登录页面切换
         <i class="iconfont" @click="goUser">e66e</i>
      </span>
      <span>

        <i class="iconfont" @click="goManage">&#xe66e;</i>
      </span>
    </div>
...
//margin-top: 100px}
//.el-input__inner {
//  border-radius: 20px; /* 设置输入框的圆角 */
//  border: 2px solid #ccc; /* 设置输入框的边框 */
//}
.el-input {
  width: 400px;
}
