        ...
        <el-col :span="5" style="background-color: grey; height: inherit">
          <div>
            ...
            <el-row style="height: 60px;background-color:rgb(240, 197, 168);border: 1px solid #eee"
              ...
              <el-col :span="6">
                <el-avatar src="https://gitee.com/yancey597/img-load/raw/master/images/202404142147645.jpg" :size="35"
                ...
                <el-row style="float:left;">
                  <div style="display: flex; align-items: center;">
                    <el-avatar v-if="message.role === 'user'"
                               src="https://gitee.com/yancey597/img-load/raw/master/images/202404142147645.jpg"
                               :size="35"></el-avatar>
